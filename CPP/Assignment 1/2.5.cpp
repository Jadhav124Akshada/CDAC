...
int main25(){
    ...
    cout<<"SafeZone : " << d.isInSafeZone(home[0],home[1],waypoint1[0],waypoint1[1],radius) << endl<<endl;

    cout<<"Waypoint 2" << endl;
    cout<<"Distance : " << d.distanceBetween(home[0],home[1],waypoint2[0],waypoint2[1])<<endl;
    cout<<"SafeZone : " << d.isInSafeZone(home[0],home[1],waypoint2[0],waypoint2[1],radius) << endl<<endl;
